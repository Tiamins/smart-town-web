  ...
  data() {
    return {
      ...
      navInfo: [
        ...
        {type: 'todo-list', title: '攻略', color: '#E3B168', url: '../guide/main'},
        {type: 'coupon', title: '美食', color: '#F56C6C', url: '../cater/main'},
        {type: 'shop', title: '购物', color: '#D77820', url: '../shop/main'},
        {type: 'smile', title: '休闲娱乐', color: '#DE5C92', url: '../hotel/main'},
        {type: 'friends', title: '行程定制', color: '#5BA775', url: '../travel/main'},
      ],
       hotNewInfo: [
