...
export default {
  data() {
    return {
      ...
      detail: {
        ...
        avgPrice: "60.00",
        score: "4.5",
        headIcon: "/static/images/cater1.jpg"
      },
      ticketList: [],
      packageInfo: [
        {
      ...
      commentList: [
        {
          ...
          score: "4.5",
          comment:
            "海洋馆里分几个部分，有不同的动物主题，大大小小的生物不少，环境还不错，一进门就像雨林似的，有代入感，每天定时有海洋动物表演，不过总体看下来内容不是很丰富，主要是海豚的表现会让人兴奋一下下，一些很小的生物在玻璃缸里游动，在灯光下仔细观察还是挺有意思的，中间看鲸鱼，被它的声音吸引。海洋馆里还有餐饮区和购物区，价格也是不便宜，总体来说，还是值得一逛，就是小贵",
          picUrls: [
            {
              pid: "p0",
        ...
        },
        {
          ...
          score: "3.5",
          comment:
            "去的时候人非常多，爆满，有白鲸、海狮，海豚等表演，里面还有各种海底世界的鱼类，最值得一提的就是里面的发光水母，真的好美好美",
          picUrls: [
            {
              pid: "p8",
        ...
        },
        {
          ...
          score: "3.5",
          comment:
            "总体来说还是不错的！但是不知道为什么取消了“触摸池”，不能真正实际感受海洋生物了……",
          picUrls: []
        }
        // {
        //   cid: 'c3',
      ...
      recommendInfo: [
        {
          ...
          avgPrice: "120.00",
          score: "5",
          headIcon: "/static/images/food1.jpeg"
        },
        {
          id: "07",
          name: "古北海洋馆",
          ...
          avgPrice: "100.00",
          score: "3.5",
          headIcon: "/static/images/sea8.jpg"
        },
        {
          id: "11",
          name: "胖哥俩蟹肉煲",
        ...
        },
        {
          ...
          avgPrice: "100.00",
          score: "4.5",
          headIcon: "/static/images/beach1.jpeg"
        },
        {
          id: "20",
          name: "season hotel",
          ...
          avgPrice: "120.00",
          score: "2.5",
          headIcon: "/static/images/hotel2.jpeg"
        }
      ]
    };
  },
  ...
  async getMerchantInfo(id) {
    ...
    this.detail = {
      id: merchant[0].merchantId,
      score: 4.5,
      name: merchant[0].name,
      headIcon: merchant[0].headIcon,
      category: merchant[0].type,
      address: merchant[0].address,
      type: merchant[0].type,
      avgPrice: 100,
      phone: merchant[0].tel
    };
  },
  async mounted() {
